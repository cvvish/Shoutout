...
export default class MultiStep extends Component {
  ...
  next() {
    const {showNextBtn} = this.state;
    !showNextBtn && this.submitAction();
    showNextBtn && this.setNavState(this.state.compState + 1)
  }
      ...
      <div className="container" onKeyDown={this.handleKeyDown}>
        ...
        <div style={this.props.showNavigation ? {} : this.hidden}>
          ...
          <button
            ...
            onClick={this.next}>{this.state.showNextBtn ? 'Next' : 'Submit'}</button>
        </div>
      </div>
    );
  }
